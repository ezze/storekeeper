...
function buildNav(members) {
    ...
    var navListClass = 'nav nav-pills nav-stacked nav-condensed';

    if (members.modules.length) {
        nav += '<h3>Modules</h3><ul class="' + navListClass + '">';
    ...
    if (members.externals.length) {
        nav += '<h3>Externals</h3><ul class="' + navListClass + '">';
    ...
    if (members.classes.length) {
        ...
        if (classNav !== '') {
            nav += '<h3>Classes</h3><ul class="' + navListClass + '">';
            nav += classNav;
            nav += '</ul>';
        }
    }
    ...
    if (members.events.length) {
        nav += '<h3>Events</h3><ul class="' + navListClass + '">';
    ...
    if (members.namespaces.length) {
        nav += '<h3>Namespaces</h3><ul class="' + navListClass + '">';
    ...
    if (members.mixins.length) {
        nav += '<h3>Mixins</h3><ul class="' + navListClass + '">';
    ...
    if (members.tutorials.length) {
        nav += '<h3>Tutorials</h3><ul class="' + navListClass + '">';
    ...
    if (members.globals.length) {
        ...
        if (!globalNav) {
            ...
            nav += '<h3>Global</h3><ul class="' + navListClass + '">' + globalNav + '</ul>';
        }
    }
